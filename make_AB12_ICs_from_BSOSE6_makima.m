...
for ii=1:52
    ...
    THETA(:,:,2*ii) = interp2(XCS,YCS,THETA_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        THETA(:,:,1) = THETA(:,:,2);
    else
...
for ii=1:52
    ...
    SALT(:,:,2*ii) = interp2(XCS,YCS,SALT_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        SALT(:,:,1) = SALT(:,:,2);
    else
...
for ii=1:52
    ...
    UVEL(:,:,2*ii) = interp2(XCS,YCS,UVEL_temp(:,:,ii),XU,YU,'makima');
    if ii==1
        UVEL(:,:,1) = UVEL(:,:,2);
    else
...
for ii=1:52
    ...
    VVEL(:,:,2*ii) = interp2(XCS,YCS,VVEL_temp(:,:,ii),XV,YV,'makima');
    if ii==1
        VVEL(:,:,1) = VVEL(:,:,2);
    else
...
for ii=1:52
    ...
    DIC(:,:,2*ii) = interp2(XCS,YCS,DIC_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        DIC(:,:,1) = DIC(:,:,2);
    else
...
for ii=1:52
    ...
    Alk(:,:,2*ii) = interp2(XCS,YCS,Alk_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        Alk(:,:,1) = Alk(:,:,2);
    else
...
for ii=1:52
    ...
    O2(:,:,2*ii) = interp2(XCS,YCS,O2_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        O2(:,:,1) = O2(:,:,2);
    else
...
for ii=1:52
    ...
    NO3(:,:,2*ii) = interp2(XCS,YCS,NO3_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        NO3(:,:,1) = NO3(:,:,2);
    else
...
for ii=1:52
    ...
    PO4(:,:,2*ii) = interp2(XCS,YCS,PO4_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        PO4(:,:,1) = PO4(:,:,2);
    else
...
for ii=1:52
    ...
    Fe(:,:,2*ii) = interp2(XCS,YCS,Fe_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        Fe(:,:,1) = Fe(:,:,2);
    else
...
for ii=1:52
    ...
    DON(:,:,2*ii) = interp2(XCS,YCS,DON_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        DON(:,:,1) = DON(:,:,2);
    else
...
for ii=1:52
    ...
    DOP(:,:,2*ii) = interp2(XCS,YCS,DOP_temp(:,:,ii),XC12,YC12,'makima');
    if ii==1
        DOP(:,:,1) = DOP(:,:,2);
    else
