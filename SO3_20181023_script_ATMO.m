...
%     acc_plots
%     hold off
%     print(['THETA_OBS_',num2str(ceil(RC(Q(qq)))),'m on ',datestr(numdate,'yyyy mmm dd'),' ',num2str(1)],'-djpeg')
%     
%     
%     for ii=2:180
%         numdate = numdate + 1;
...
%         acc_movie
%         text(293,-37.5,datestr(numdate,'yyyy mmm dd'),'FontSize',16);
%         print(['THETA_OBS_',num2str(ceil(RC(Q(qq)))),'m on ',datestr(numdate,'yyyy mmm dd'),' ',num2str(ii)],'-djpeg')
%         hold off
%     end
%     
%     close all
...
for qq=9:-1:1
    ...
    acc_plots
    hold off
    print(['SALT_OBS_',num2str(ceil(RC(Q(qq)))),'m on ',datestr(numdate,'yyyy mmm dd'),' ',num2str(1)],'-djpeg')
    ...
    for ii=2:180
        ...
        acc_movie
        text(293,-37.5,datestr(numdate,'yyyy mmm dd'),'FontSize',16);
        print(['SALT_OBS_',num2str(ceil(RC(Q(qq)))),'m on ',datestr(numdate,'yyyy mmm dd'),' ',num2str(ii)],'-djpeg')
