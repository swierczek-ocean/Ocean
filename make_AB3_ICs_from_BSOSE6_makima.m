...
for ii=1:52
    ...
    THETA(:,:,ii) = interp2(XCS,YCS,THETA_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    SALT(:,:,ii) = interp2(XCS,YCS,SALT_temp(:,:,ii),XC3,YC3,'makima');    
end
...
for ii=1:52
    ...
    DIC(:,:,ii) = interp2(XCS,YCS,DIC_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    Alk(:,:,ii) = interp2(XCS,YCS,Alk_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    O2(:,:,ii) = interp2(XCS,YCS,O2_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    NO3(:,:,ii) = interp2(XCS,YCS,NO3_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    PO4(:,:,ii) = interp2(XCS,YCS,PO4_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    Fe(:,:,ii) = interp2(XCS,YCS,Fe_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    DON(:,:,ii) = interp2(XCS,YCS,DON_temp(:,:,ii),XC3,YC3,'makima');
end
...
for ii=1:52
    ...
    DOP(:,:,ii) = interp2(XCS,YCS,DOP_temp(:,:,ii),XC3,YC3,'makima');
end
