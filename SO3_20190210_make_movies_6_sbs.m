...
%     end  
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['MITGCM vs. Argo DIC (mol C/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_1
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['BSOSE vs. Argo DIC (mol C/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_2
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    
    set(gca, 'nextplot','replacechildren', 'Visible','on');
    vidObj = VideoWriter(['DIC_SBS_OBS_',num2str(depth_names(qq)),'m.avi']);
    vidObj.Quality = 100;
    vidObj.FrameRate = 7;
    open(vidObj);
...
%     end    
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['MITGCM vs. Argo alkalinity (mol eq) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_1
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    hold off
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['BSOSE vs. Argo alkalinity (mol eq) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_2
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    
    set(gca, 'nextplot','replacechildren', 'Visible','on');
    vidObj = VideoWriter(['ALK_SBS_OBS_',num2str(depth_names(qq)),'m.avi']);
    vidObj.Quality = 100;
    vidObj.FrameRate = 7;
    open(vidObj);
    writeVideo(vidObj, getframe(gcf));
...
%     end    
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['MITGCM vs. Argo nitrate (mol NO_3/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_1
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    hold off
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['BSOSE vs. Argo nitrate (mol NO_3/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_2
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    
    set(gca, 'nextplot','replacechildren', 'Visible','on');
    vidObj = VideoWriter(['NO3_SBS_OBS_',num2str(depth_names(qq)),'m.avi']);
    vidObj.Quality = 100;
    vidObj.FrameRate = 7;
    open(vidObj);
    writeVideo(vidObj, getframe(gcf));
...
%     end    
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['MITGCM vs. Argo dissolved oxygen (mol O/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_1
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    hold off
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['BSOSE vs. Argo dissolved oxygen (mol O/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_2
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    
    set(gca, 'nextplot','replacechildren', 'Visible','on');
    vidObj = VideoWriter(['O2_SBS_OBS_',num2str(depth_names(qq)),'m.avi']);
    vidObj.Quality = 100;
    vidObj.FrameRate = 7;
    open(vidObj);
    writeVideo(vidObj, getframe(gcf));
...
%     end    
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['MITGCM vs. Argo phosphate (mol PO4/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_1
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    hold off
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['BSOSE vs. Argo phosphate (mol PO4/m) at ',num2str(depth_names(qq)),'m depth'],'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_sbs_plots_2
    text(291.5,-34,datestr(numdate,'yyyy mmm'),'FontSize',28,'Color','w')
    
    set(gca, 'nextplot','replacechildren', 'Visible','on');
    vidObj = VideoWriter(['PO4_SBS_OBS_',num2str(depth_names(qq)),'m.avi']);
    vidObj.Quality = 100;
    vidObj.FrameRate = 7;
    open(vidObj);
    writeVideo(vidObj, getframe(gcf));
