...
O2_Obs_Array1 = zeros(n_obs,100);
NO3_Obs_Array1 = zeros(n_obs,100);
CHL_Obs_Array1 = zeros(n_obs,100);
PH_Obs_Array1 = zeros(n_obs,100);
DIC_LIAR_Obs_Array1 = zeros(n_obs,100);
DIC_MLR_Obs_Array1 = zeros(n_obs,100);
DIC_CANY_Obs_Array1 = zeros(n_obs,100);
ALK_LIAR_Obs_Array1 = zeros(n_obs,100);
ALK_MLR_Obs_Array1 = zeros(n_obs,100);
ALK_CANY_Obs_Array1 = zeros(n_obs,100);
PCO_LIAR_Obs_Array1 = zeros(n_obs,100);
PCO_MLR_Obs_Array1 = zeros(n_obs,100);
PCO_CANY_Obs_Array1 = zeros(n_obs,100);
counter = 1;
...
O2_Obs_Array = [O2_Obs_Array1;O2_Obs_Array2];
NO3_Obs_Array = [NO3_Obs_Array1;NO3_Obs_Array2];
CHL_Obs_Array = [CHL_Obs_Array1;CHL_Obs_Array2];
PH_Obs_Array = [PH_Obs_Array1;PH_Obs_Array2];
DIC_LIAR_Obs_Array = [DIC_LIAR_Obs_Array1;DIC_LIAR_Obs_Array2];
DIC_MLR_Obs_Array = [DIC_MLR_Obs_Array1;DIC_MLR_Obs_Array2];
DIC_CANY_Obs_Array = [DIC_CANY_Obs_Array1;DIC_CANY_Obs_Array2];
ALK_LIAR_Obs_Array = [ALK_LIAR_Obs_Array1;ALK_LIAR_Obs_Array2];
ALK_MLR_Obs_Array = [ALK_MLR_Obs_Array1;ALK_MLR_Obs_Array2];
ALK_CANY_Obs_Array = [ALK_CANY_Obs_Array1;ALK_CANY_Obs_Array2];
PCO_LIAR_Obs_Array = [PCO_LIAR_Obs_Array1;PCO_LIAR_Obs_Array2];
PCO_MLR_Obs_Array = [PCO_MLR_Obs_Array1;PCO_MLR_Obs_Array2];
PCO_CANY_Obs_Array = [PCO_CANY_Obs_Array1;PCO_CANY_Obs_Array2];
