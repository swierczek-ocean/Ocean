...
for ii=1:52
    for jj=1:60
        DIC(:,:,ii,jj) = interp2(XCS,YCS,DIC_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        ALK(:,:,ii,jj) = interp2(XCS,YCS,ALK_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        O2(:,:,ii,jj) = interp2(XCS,YCS,O2_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        NO3(:,:,ii,jj) = interp2(XCS,YCS,NO3_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        PO4(:,:,ii,jj) = interp2(XCS,YCS,PO4_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        FE(:,:,ii,jj) = interp2(XCS,YCS,FE_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        DON(:,:,ii,jj) = interp2(XCS,YCS,DON_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        DOP(:,:,ii,jj) = interp2(XCS,YCS,DOP_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        THETA(:,:,ii,jj) = interp2(XCS,YCS,THETA_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        SALT(:,:,ii,jj) = interp2(XCS,YCS,SALT_temp(:,:,ii,jj),XC3,YC3,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        UVEL(:,:,ii,jj) = interp2(XCS,YCS,UVEL_temp(:,:,ii,jj),XU,YU,'makima');
    end
end
...
for ii=1:52
    for jj=1:60
        VVEL(:,:,ii,jj) = interp2(XCS,YCS,VVEL_temp(:,:,ii,jj),XV,YV,'makima');
    end
end
