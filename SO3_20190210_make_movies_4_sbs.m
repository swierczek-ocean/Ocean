...
for qq=1:6
    ...
    xtickformat('degrees')
    ytickformat('degrees')
    title(['BSOSE vs. Argo temperature (degrees C) at ',num2str(depth_names(qq)),'m depth during ',datestr(numdate,'yyyy mmm dd')],'FontWeight','Normal')
    acc_movie
    acc_sbs_plots_2
...
for qq=1:6
    ...
    for ii=2:NZ
        ...
        caxis([lb ub])
        axis(coords)
        title(['BSOSE vs. Argo salinity (psu) at ',num2str(depth_names(qq)),'m depth during ',datestr(numdate,'yyyy mmm dd')],'FontWeight','Normal')
        xtickformat('degrees')
        ytickformat('degrees')
        acc_movie
        acc_sbs_plots_2
